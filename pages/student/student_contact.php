...
<head>
    ...
    <title>ArcherFind - Contact Us</title>
    ...
    <header>
        ...
        <nav class="navbar">
            <ul class="nav-links">
                ...
                <li><a href="../../pages/student/student_contact.php" class="current-page">Contact Us</a></li>
                <li>
                    <!-- user profile -->
        ...
        <section class="contact-us">
            <div class="title">
                ...
                <div class="contact-details">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px">
                        <path
                            d="M544-496q26-26 26-64t-26-64q-26-26-64-26t-64 26q-26 26-26 64t26 64q26 26 64 26t64-26ZM480-46Q303-193 214.5-313T126-556q0-164 107-261t247-97q140 0 247 97t107 261q0 123-88.5 243T480-46Z" />
                    </svg>
                    <p> De La Salle University: 2401 Taft Avenue, Manila, 1004 Philippines </p>
                </div>
                <div class="contact-details">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px">
                        <path
                            d="M800-86q-131 0-259-57T307-305Q201-411 144-539.5T87-799q0-32 21-53.5t53-21.5h161q37 0 60 18t31 52l25 119q6 31-.5 53T411-593l-103 90q16 26 37.5 52.5T396-396q26 26 50 45.5t48 33.5l101-98q20-19 44.5-25.5t53.5-.5l111 25q35 10 52.5 31t17.5 55v169q0 32-21.5 53.5T800-86Z" />
                    </svg>
                    <p>+63 123 4567 890</p>
                </div>
                <div class="contact-details">
                    ...
                    <p>archerfind@dlsu.edu.ph</p>
                </div>

                <p class="contact-description">
                    We here at ArcherFind are dedicated to providing the DLSU community with a reliable, seamless
                    experience while recovering or reporting items on campus. If you have questions about a claim, need
                    technical support, or want to provide feedback, please use the form below to select a topic and send
                    a message directly to our team. </p>

        </section>

        <section class="contact-form">
            <form class="contact-form-details" action="../../controllers/ContactsReceivedController.php" method="POST">
