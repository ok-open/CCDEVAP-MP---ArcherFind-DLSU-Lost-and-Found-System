...
<body>
            ...
            <ul class="nav-links">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="../../pages/student/student_surrender-form.php" class="current-page">Report Found</a></li>
                    </ul>
                </li>
    ...
    <div class="surrender-wrapper">
        ...
        <!-- SURRENDER FORM -->
        <form class="form-wrapper" method="POST" enctype="multipart/form-data" action="../../controllers/ReportsController.php?action=surrender">            <!-- LEFT SIDE -->
                        ...
                        <div class="question-box">
                            ...
                            <select id="category" name="category_id" required>
                                ...
                                <?php foreach ($categories as $categoryOption): ?>
                                    <option value="<?= $categoryOption["category_id"] ?>">
