    ...
    <div class="wrapper">
        ...
        <section class="logo-intro">
            ...
            <div class="title-desc">
                <div class="archerfind-logo">
                    <h1>ArcherFind</h1>
                    <img class="logo" src="../../assets/LOGOS/AF-ORIGINAL.png" alt="../../assets/LOGOS/AF-ORIGINAL.png">
                </div>
                <p>
        ...
        <section class="login-register-page">
            <div class="login-register-box">
                ...
                <!-- LOGIN DETAILS (FLEX) -->
                <form action="../../controllers/UsersController.php?action=register" method="POST"> <!-- SHOULD BE CHANGED SOON DEPENDING ON LOGIN CREDENTIALS -->
                        ...
                        <div class="form password-form">
                            ...
                            <div class="password-input-wrapper">
                                ...
                                <button type="button" class="see-pass" aria-label="Toggle password visibility">
                                    ...
                                    <svg class="eye-open" xmlns="http://www.w3.org/2000/svg" height="24px"
                                        viewBox="0 -960 960 960" width="24px">
                                        <path
